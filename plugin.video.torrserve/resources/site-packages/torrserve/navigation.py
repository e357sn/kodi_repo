...
def search(params):
    ...
    if params.mod == "index":
        ...
        if query:
            ...
            return Plugin.create_listing(listing, category="{0}: {1}".format(translate("Search"), query), sort_methods=xbmcplugin.SORT_METHOD_SIZE, cache_to_disk=True)
    return False
